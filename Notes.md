...
Тип реузльтирующего набора определяет, как может быть использован подзапрос.
Подзапрос пишется внутри круглых скобок.

Некорелированные запросы независимы и могут выполняться автономно,
